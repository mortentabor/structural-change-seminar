...
| [`05-forecast-errors-exhibit.ipynb`](notebooks/05-forecast-errors-exhibit.ipynb) | Workshop 2 exhibit: the forecast-error regression revisited — your own splits vs. the Bai–Perron break dates, and from finding to question. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mortentabor/structural-change-seminar/blob/main/notebooks/05-forecast-errors-exhibit.ipynb) |
