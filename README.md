...
| [`04-return-predictability.ipynb`](notebooks/04-return-predictability.ipynb) | Workshop 2 exhibit: predicting stock returns with the dividend–price ratio, 1927–2021 — where the full sample hides what the subsamples reveal. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mortentabor/structural-change-seminar/blob/main/notebooks/04-return-predictability.ipynb) |
