...
| [`05-forecasting-inflation.ipynb`](notebooks/05-forecasting-inflation.ipynb) | Workshop 2 exhibit: professional forecasters vs. a naive rule — an accuracy advantage that collapses exactly when it matters most. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mortentabor/structural-change-seminar/blob/main/notebooks/05-forecasting-inflation.ipynb) |
| [`06-forecasting-with-breaks.ipynb`](notebooks/06-forecasting-with-breaks.ipynb) | The information ladder: constant, rolling, and oracle break-adjusted AR forecasts vs. the naive rule and the SPF — does knowing the breaks help? Less than you'd think. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mortentabor/structural-change-seminar/blob/main/notebooks/06-forecasting-with-breaks.ipynb) |
