...
main()
{
    ...
    // two of the variations, as examples -- add your own (5% trimming is the
    // one to look at: see the CHECK above)
    r.BaiPerron(5, 0.05, {{"label", "BP 5% trimming"}});
    r.GetModel("BP 5% trimming").PrintTests();
